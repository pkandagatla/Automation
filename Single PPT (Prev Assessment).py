...
template_path = r"C:\Users\pragna_kandagatla\Desktop\Assessment PPT\AR Assessment - PPT - template - prev assessment.pptm"
excel_path = r"C:\Users\pragna_kandagatla\Desktop\PVE\AR Assessment - Paradise Valley (PVE).xlsx"
...
rows_to_delete = 13 - len(ar_table)
...
prev_assessment = list(template_assessment_metrics.iloc[row_no-1,col_no+1:])
