...
path_folder = r"C:/Users/pragna_kandagatla/Desktop/Automation/Automation_LPC"
...
Aging_report_df=iter_row_slicer(Aging_report_df,"Payor Type Summary",1)
...
payer_grp_file=copy_paste_raw(payer_grp_file,"Payer Grouping",payers_list,row_no+1,col_no-1,col_no)
...
#Getting position
row_num, col_num=coordinate_finder_insheet(template_path,"Clean Up estimates","Payer Type")
row_end, col_end=coordinate_finder_insheet(template_path,"Clean Up estimates","Payer Type Total")
...
#Delete unwated rows
deleting_below_rows(file_saving_location,"Clean Up estimates",start_row,no_of_row)
